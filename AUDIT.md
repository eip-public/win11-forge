...
- Three different logging styles across bash scripts — **fixed** (commit pending; shallow extract of ok/warn/die into vm-setup/lib/log.sh; each script keeps its own log() because conventions differ intentionally)
